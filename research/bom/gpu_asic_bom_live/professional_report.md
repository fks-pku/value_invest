...
> 研究截面：2026-08-03。时间线按材料发布时间由近及远；同一材料只有经过当前问题的独立解析和复核后，才进入该问题。

### 当前投资判断

**动作状态：** watch_only

Q2需求量证据已扩展到7类当前需求方和5类潜在未来需求方，新增OpenAI、IREN、Nebius、Meta、韩国工业集团、英国、欧洲电信与日本公共算力等官方项目。新增信息显著提高需求广度，却仍混合已安装、已下单、签约、连接、在建、系统、GW与预算，不能建立可加总GPU需求或直接推出证券收益。公司盈利桥、反向估值和量化风险控制仍未通过，维持观察。

| 基本面变化 | 市场共识变化 | 定价变化 |
|---|---|---|
| 相较8月2日，企业/工业缺口被两家5万颗级计划替代，Meta增加12.9万颗H100已建集群，GPU云和AI模型公司增加多主体容量；潜在未来五类均形成入口样本。需求覆盖改善，但实际交付与利用率仍是核心断点。 | 大规模AI基础设施扩张已同时出现在公司、政府和投行材料中，方向性共识更强；预期差转向规划兑现率、利用率及GPU与ASIC具体份额。 | 本次没有更新证券价格、一致预期或反向估值；新增需求项目不能替代公司级收入、毛利、自由现金流和估值桥。 |

**研究覆盖：** 27 / 27 个逻辑节点已有截面；56 / 56 条原子观点完成映射。
...
Q2已从7类当前需求方单样本框架扩展为7类当前需求方、5类潜在未来需求方和其它预测的完整矩阵。新增官方来源显示，AI模型公司已有OpenAI超过200万颗在建芯片容量和Mistral 1.8万套系统规划；GPU云新增IREN约15万颗已安装或已下单GPU及Nebius超过3.5GW签约功率；Meta披露12.9万颗H100已建单集群；Samsung、SK、Hyundai、英国、Telefónica和日本Noetra分别形成工业、物理AI、主权、边缘和区域公共算力样本。现有TPU与AMD投行材料也已按AI模型公司重新映射。所有信息仍跨安装、订单、签约、系统、GPU、GW和预算口径，不能加总为GPU总需求。

**趋势变化：** 信息覆盖由当前需求方7/7但一类缺口，提升到当前7/7与潜在未来5/5均有记录；企业/工业缺口被项目样本替代。由于规划和代理占比仍高，Q2节点维持弱状态，下一步转向实际交付、上线与利用率验证。
