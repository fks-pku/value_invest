...
def _build_user_prompt(
    ...
    sections.extend([
        ...
        "",
        "### 3. QA Drilldown",
        "Expand only the necessary next level, never beyond L5. Research each terminal question before drilling deeper on a concrete gap: data, analysis, conclusion, sufficiency judgment, gaps, triggers, and source links. Parents synthesize their children.",
        "",
