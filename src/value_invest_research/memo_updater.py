...
def _build_user_prompt(ticker: str, context: dict[str, Any]) -> str:
    ...
    sections.extend([
        ...
        "2. **FengHe 3C Analysis**: Cycle, Change, and Certainty with evidence IDs or data sources.",
        "3. **FengHe 3D Price Drivers**: D1, D2, D3, and the single dominant_driver.",
        "4. **FengHe 5M Value Analysis**: M1 through M5, including at least one value driver and one defect risk.",
        "5. **FengHe 3T Time Frame**: T1, T2, or T3, with why the evidence horizon matches it.",
        "6. **Proposed Section Updates**: For each FengHe memo section that should change, provide the updated markdown.",
        "7. **Stock Signal** (YAML format):",
        "```yaml",
        "ticker: ...",
        "date: ...",
        ...
        "- Apply FengHe 3C3D5M3T strictly; do not substitute generic value-investing categories.",
