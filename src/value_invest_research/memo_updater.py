...
def _build_system_prompt() -> str:
    parts = [
        ...
        _load_skill_file("frameworks/value_investing.md"),
...
def _build_user_prompt(ticker: str, context: dict[str, Any]) -> str:
    ...
    sections.extend([
        ...
        "2. **Proposed Section Updates**: For each memo section that should change, provide the updated markdown.",
        "3. **Stock Signal** (YAML format):",
        "```yaml",
        "ticker: ...",
        "date: ...",
